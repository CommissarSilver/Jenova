        ...
        if self.data_format == "simple":
            ...
            for i in range(df.shape[0]):
                ...
                if df["cycle_id"][i] != previous_cycle_commit:
                    assert len(
                        df.loc[df["cycle_id"] == previous_cycle_commit]
                    ) == cycle_ids.count(cycle_id)
        ...
        if self.data_format == "simple":
            for i in range(min_cycle, max_cycle + 1):
                ...
                for index, test_case in cycle_rew_data.iterrows():
                    ci_cycle_log.add_test_case(
                        test_id=test_case["Id"],
                        test_suite=test_case["Name"],
            ...
            for i in range(min_cycle, max_cycle + 1):
                ...
                for index, test_case in cycle_rew_data.iterrows():
                    ...
                    ci_cycle_log.add_test_case_enriched(
                        test_id=test_case["test_class_name"],
